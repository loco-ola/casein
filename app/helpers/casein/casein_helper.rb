module Casein
  module CaseinHelper
    ...
    def casein_no_yes_label value
      ...
      casein_form_tag_wrapper(form.collection_select( attribute, collection, value_method, text_method, strip_casein_options(options), merged_class_hash(options, 'form-control')), form, obj, attribute, options).html_safe
    end
